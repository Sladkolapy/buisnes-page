...
export function ProfileCard({ profile }: ProfileCardProps) {
  ...
  return (
    <div className="group flex flex-col gap-3 rounded-2xl border border-zinc-200 bg-white p-5 transition hover:border-violet-300 hover:shadow-sm dark:border-zinc-700 dark:bg-zinc-900 dark:hover:border-violet-700">
      ...
      <Link
        ...
        className="mt-auto inline-flex items-center justify-center rounded-lg bg-violet-600 px-4 py-2 text-xs font-medium text-white transition hover:bg-violet-700"
      >
        Записаться
      </Link>
    </div>
